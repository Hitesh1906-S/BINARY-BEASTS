...
//}, []);
  ...
  try {
    ...
    resultMessage += `Legitimacy: ${result.is_legit ? '✅ Likely Legitimate' : '⚠️ Potential Scam'}\n\n`;
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <div className={`mb-4 p-3 rounded-lg ${
            ...
            <h4 className="font-bold text-lg mb-1">
              {analysisResult.is_legit ? '✅ Likely Legitimate Job Offer' : '⚠️ Potential Scam Detected'}
            </h4>
